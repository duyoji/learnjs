_xamzrequire = function e(t, r, n) {
    ...
    84: [function(e, t, r) {
        (function() {
            ...
            n = e("./XMLFragment"), r = function() {
                function e(e, t, r) {
                    var i, s, o;
                    if (this.children = [], this.rootObject = null, this.is(e, "Object") && (o = [e, t], t = o[0], r = o[1], e = null), null != e && (e = "" + e || "", null == t && (t = {
                            version: "1.0"
                        })), null != t && null == t.version) throw new Error("Version number is required");
                    if (null != t) {
        ...
        (function() {
            ...
            e = function() {
                ...
                return e.prototype.element = function(t, n, i) {
                    ...
                    if (0 === this.children.length) null == this.value && (u += "?xml" === this.name ? "?>" : "!DOCTYPE" === this.name ? ">" : "/>"), a && (u += o);
                    else if (a && 1 === this.children.length && this.children[0].value) u += ">", u += this.children[0].value, u += "</" + this.name + ">", u += o;
                    else {
        ...
        n.EventListeners = {
            ...
            Core: (new i).addNamedListeners(function(e, t) {
                t("VALIDATE_CREDENTIALS", "validate", function(e, t) {
                    ...
                    if (e.error)
                        if (e.error.redirect && e.redirectCount < e.maxRedirects) e.error.retryDelay = 0;
    ...
    45: [function(e, t, r) {
        ...
        function h(e) {
            var t = this;
            if (s.apply(this, arguments), "header" === this.location) n(this, "timestampFormat", "rfc822");
    ...
    47: [function(e, t, r) {
        ...
        function s(e) {
            ...
            if (e.request.service.config.convertResponseTypes === !1) e.data = JSON.parse(t);
            else {
    ...
    25: [function(e, t, r) {
        ...
        n.CognitoIdentityCredentials = n.util.inherit(n.Credentials, {
            ...
            createClients: function() {
                this.webIdentityCredentials = this.webIdentityCredentials || new n.WebIdentityCredentials(this.params), this.cognito = this.cognito || new n.CognitoIdentity({
                    params: this.params
    ...
    20: [function(e, t, r) {
        (function(t, n) {
            ...
            function l(e, t, r, n, i) {
                for (var s = [], o = 0, a = t.length; a > o; ++o) L(t, String(o)) ? s.push(p(e, t, r, n, String(o), !0)) : s.push("");
            ...
            function p(e, t, r, n, i, s) {
                ...
                if (c = Object.getOwnPropertyDescriptor(t, i) || {
                        value: t[i]
                    }, c.get ? a = c.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : c.set && (a = e.stylize("[Setter]", "special")), L(n, i) || (o = "[" + i + "]"), a || (e.seen.indexOf(c.value) < 0 ? (a = g(r) ? u(e, c.value, null) : u(e, c.value, r - 1), a.indexOf("\n") > -1 && (a = s ? a.split("\n").map(function(e) {
                        return "  " + e
                    }).join("\n").substr(2) : "\n" + a.split("\n").map(function(e) {
                        return "   " + e
            ...
            r.debuglog = function(e) {
                if (E(O) && (O = t.env.NODE_DEBUG || ""), e = e.toUpperCase(), !j[e])
    ...
    18: [function(e, t, r) {
        ...
        n.prototype.parse = function(e, t, r) {
            ...
            if (!x[i] && (o || i && !A[i])) {
                ...
                if (!m)
                    for (var g = this.hostname.split(/\./), c = 0, T = g.length; T > c; c++) {
                        var q = g[c];
                        if (q && !q.match(E)) {
            ...
            for (var v = d.slice(-1)[0], y = (r.host || e.host) && ("." === v || ".." === v) || "" === v, w = 0, b = d.length; b >= 0; b--) v = d[b], "." == v ? d.splice(b, 1) : ".." === v ? (d.splice(b, 1), w++) : w && (d.splice(b, 1), w--);
            if (!p && !f)
                for (; w--; w) d.unshift("..");
            ...
            ! function(n) {
                ...
                function f(e) {
                    ...
                    for (n = s = b.length, s && b.push(_); g > n;) {
                        ...
                        for (v = n + 1, c - t > D((E - r) / v) && i("overflow"), r += (c - t) * v, t = c, u = 0; g > u; ++u)
    ...
    10: [function(e, t, r) {
        var n = e("./helpers"),
            ...
            f = function(e, t) {
                var r, n, s, o, f, d, m, g, v, y, w, b, E = new Array(1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298),
    ...
    9: [function(e, t, r) {
        function n(e, t) {
            e[t >> 5] |= 128 << 24 - t % 32, e[(t + 64 >> 9 << 4) + 15] = t;
            for (var r = Array(80), n = 1732584193, u = -271733879, c = -1732584194, h = 271733878, l = -1009589776, p = 0; p < e.length; p += 16) {
    ...
    5: [function(e, t, r) {
        ...
        function i(e, t, r) {
            for (var n = new o(t), i = r ? n.writeInt32BE : n.writeInt32LE, s = 0; s < e.length; s++) i.call(n, e[s], 4 * s, !0);
            return n
        }
    ...
    82: [function(e, t, r) {
        ...
        function o(e, t) {
            for (var r = {}, n = t.key.name || "key", s = t.value.name || "value", o = t.flattened ? t.name : "entry", a = e.firstElementChild; a;) {
                if (a.nodeName === o) {
        ...
        function a(e, t) {
            for (var r = [], n = t.flattened ? t.name : t.member.name || "member", s = e.firstElementChild; s;) s.nodeName === n && r.push(i(s, t.member)), s = s.nextElementSibling;
            return r
        }
        ...
        function c(e) {
            ...
            for (var t = {
                ...
                var n = r.nodeName;
                t.members.hasOwnProperty(n) ? t.members[n].type = "list" : t.members[n] = {
                    name: n
...
AWS.apiLoader.services.dynamodb = {}, AWS.DynamoDB = AWS.Service.defineService("dynamodb", ["2011-12-05", "2012-08-10"]), _xamzrequire = function t(e, r, n) {
    ...
    64: [function(t, e, r) {
        ...
        t("../dynamodb/document_client"), n.util.update(n.DynamoDB.prototype, {
            ...
            retryDelays: function() {
                for (var t = this.numRetries(), e = [], r = 0; t > r; ++r) 0 === r ? e.push(0) : e.push(50 * Math.pow(2, r - 1));
                return e
            }
        })
    }, {
    ...
    30: [function(t, e, r) {
        function n(t) {
            ...
            if ("Array" === o(t)) {
                for (var a = {
                        L: []
                    }, u = 0; u < t.length; u++) a.L.push(n(t[u]));
                return a
            }
            return "Set" === o(t) ? i(t) : "String" === o(t) ? {
                S: t
            } : "Number" === o(t) ? {
                N: t.toString()
            } : "Binary" === o(t) ? {
    ...
    32: [function(t, e, r) {
        var n = t("../core").util,
            ...
            a = n.inherit({
                ...
                validate: function() {
                    for (var t = this, e = t.values.length, r = t.values, a = 0; e > a; a++)
                        if (i(r[a]) !== t.type) throw n.error(new Error, {
                            code: "InvalidType",
